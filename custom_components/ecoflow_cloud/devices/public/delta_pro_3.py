...
class DeltaPro3(BaseDevice):
    def sensors(self, client: EcoflowApiClient) -> list[BaseSensorEntity]:
        return [
            ...
            InWattsSolarSensorEntity(client, self, "powGetPvH", const.PV_HV_IN_POWER),
            InWattsSolarSensorEntity(client, self, "powGetPvL", const.PV_LV_IN_POWER),
            ...
            OutWattsDcSensorEntity(client, self, "powGetTypec1", const.TYPEC_1_OUT_POWER),
            OutWattsDcSensorEntity(client, self, "powGetTypec2", const.TYPEC_2_OUT_POWER),
            OutWattsDcSensorEntity(client, self, "powGet12v", const.DC_CAR_OUT_POWER),
            OutWattsDcSensorEntity(client, self, "powGet24v", const.DC_ANDERSON_OUT_POWER),
            ...
            OutWattsDcSensorEntity(client, self, "powGetQcusb1", const.USB_QC_1_OUT_POWER),
            OutWattsDcSensorEntity(client, self, "powGetQcusb2", const.USB_QC_2_OUT_POWER),
            OutWattsDcSensorEntity(client, self, "powGet4p81", const.SLAVE_N_OUT_POWER % 1),
            OutWattsDcSensorEntity(client, self, "powGet4p82", const.SLAVE_N_OUT_POWER % 2),
